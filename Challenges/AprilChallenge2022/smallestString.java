...
//         ParentId, Priority queue of Characters mapped to the parentId
...
//         Pq is made properly according to the character present at a parent position.
...
//         Make the strings according to the parent index.
        for(int i=0;i<str.length;i++){
            int parentId = uf.getAbsoluteParent(i);
            str[i] = map.get(parentId).remove();
        }
